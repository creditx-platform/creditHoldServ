...
class TransactionEventListenerTest {
    ...
    void shouldProcessValidTransactionAuthorizedEvent() throws Exception {
        ...
        Message<String> message = MessageBuilder
                .withPayload(payload)
                .setHeader("eventType", EventTypes.TRANSACTION_AUTHORIZED)
                .build();
        ...
        try (MockedStatic<EventValidationUtils> mockedUtils = Mockito.mockStatic(EventValidationUtils.class)) {
            mockedUtils.when(() -> EventValidationUtils.validateEventType(message, EventTypes.TRANSACTION_AUTHORIZED))
                    .thenReturn(true);
    ...
    void shouldProcessValidTransactionPostedEvent() throws Exception {
        ...
        Message<String> message = MessageBuilder
                .withPayload(payload)
                .setHeader("eventType", EventTypes.TRANSACTION_POSTED)
                .build();
    ...
    void shouldProcessValidTransactionFailedEvent() throws Exception {
        ...
        Message<String> message = MessageBuilder
                .withPayload(payload)
                .setHeader("eventType", EventTypes.TRANSACTION_FAILED)
                .build();
        ...
        try (MockedStatic<EventValidationUtils> mockedUtils = Mockito.mockStatic(EventValidationUtils.class)) {
            mockedUtils.when(() -> EventValidationUtils.validateEventType(message, EventTypes.TRANSACTION_FAILED))
                    .thenReturn(true);
    ...
    void shouldThrowExceptionOnJsonProcessingError() throws Exception {
        ...
        try (MockedStatic<EventValidationUtils> mockedUtils = Mockito.mockStatic(EventValidationUtils.class)) {
            ...
            when(objectMapper.readValue(payload, TransactionAuthorizedEvent.class))
