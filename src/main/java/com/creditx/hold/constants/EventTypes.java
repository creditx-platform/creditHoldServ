package com.creditx.hold.constants;

/**
 * Constants for event types used throughout the credit system.
 * These match the actual event types stored in the outbox schema and published to topics.
 */
